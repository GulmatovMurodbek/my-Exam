...
let UserOfCheque=JSON.parse(localStorage.getItem("cart"))
console.log(UserOfCheque);

let Cart = JSON.parse(localStorage.getItem("cart")) || [];  
let tbody = document.querySelector("tbody");  
let cout = document.querySelector(".CouterOf"); 
let AllPriceOfProduct = document.querySelector(".AllPriceOfProduct"); 
let AllPriceOfProduct2 = document.querySelector(".AllPriceOfProduct2"); 
...
function getUser(user) {
  ...
  Object.values(UnicalCard).forEach(element => {
    ...
    TdAvatar.innerHTML = `<img style="width:40px" src="${element.Avatar}" alt="">
                          <h1>${element.Name}</h1>`
...
AllPriceOfProduct.innerHTML=cnt+"$"
AllPriceOfProduct2.innerHTML=cnt+"$"
// Total.innerHTML=cnt+" $ "